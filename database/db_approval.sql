...
CREATE TABLE `approval` (
  ...
  `id_status_approval` int(12) NOT NULL,
  `perihal_approval` varchar(100) NOT NULL,
...
INSERT INTO `approval` (`id_approval`, `id_user`, `alasan`, `tgl_diajukan`, `mulai`, `berakhir`, `id_status_approval`, `perihal_approval`, `alasan_verifikasi`) VALUES
('approval-060ae', 'c551fc8847d29dc25a23db5d2cdb941b', 'approval Sakit SAkit', '2022-08-06', '2022-08-04', '2022-08-17', 2, 'approval Sakit', 'YEs'),
('approval-06a5f', '40bae2603ae22725d35def9e7c48b0d6', 'Menghadiri Rapat Orang Tua Siswa di Sekolahan', '2022-08-11', '2022-08-22', '2022-08-23', 1, 'Rapat Orang Tua Siswa', NULL),
('approval-203c6', '1fcaef592c1b8f4b733b04e19be58f99', 'Menemani study tour anak di Bali', '2022-08-11', '2022-09-04', '2022-09-16', 3, 'study tour', 'Ada rapat penting'),
('approval-285ed', '8ac5e3b30c2f0091eef898158122d131', 'Liburan muncak di Gunug Lawu', '2022-08-11', '2022-08-27', '2022-08-29', 1, 'Muncak', NULL),
('approval-3d2a7', '263a76c22eb8acf8c3e08edd55c1421d', 'Menghadiri acara wisuda anak di sekolahan', '2022-08-11', '2022-08-22', '2022-08-23', 1, 'Anak Wisuda', NULL),
('approval-5ae57', '66d0de4b6aab1f34ed9d8779f375a2ea', 'Karena Sakit Demam', '2022-08-11', '2022-08-13', '2022-08-15', 2, 'Sakit', 'sakit'),
('approval-714f0', '592d06bdc0ee778dab4e01d55ba8b14c', 'Karena ibu saya sakit', '2022-06-15', '2022-06-12', '2022-06-30', 1, 'approval Libur', NULL),
('approval-7d81b', 'beecc6bfae05c7fba5a19f27f41a27ec', 'Muncak di Gunug Lawu sama Alvian', '2022-08-11', '2022-08-27', '2022-08-29', 1, 'Muncak', NULL),
('approval-89c0c', '2fbb953bcaf76ff9d669197a6d9b6733', 'Membantu panen kebun orang tua', '2022-08-11', '2022-08-12', '2022-08-13', 1, 'Panen', NULL),
('approval-99215', 'ebeeaf891bcf293ec607f50475648ddc', 'menemani ibu saya yang sakit, sekarang beliau masih berada dirumah sakit dan butuh saya temani selama seminggu.', '2022-06-06', '2022-06-06', '2022-06-15', 2, 'berobat', NULL),
('approval-a2f13', '39332f054c98c54e4eda83e1274566ed', 'melahirkan anak pertama', '2022-08-11', '2022-08-13', '2022-11-01', 2, 'approval Melahirkan', 'melahirkan'),
('approval-ede81', 'dce802a5e29e9ccabc144dfb6a37abbb', 'Liburan ke lampung', '2022-06-21', '2022-06-21', '2022-06-21', 2, 'approval Libur', NULL);
...
CREATE TABLE `status_approval` (
  `id_status_approval` int(11) NOT NULL,
...
INSERT INTO `status_approval` (`id_status_approval`, `status_approval`) VALUES
(1, 'Menunggu Konfirmasi'),
(2, 'Izin approval Diterima'),
(3, 'Izin approval Ditolak');
...
ALTER TABLE `status_approval`
  ADD PRIMARY KEY (`id_status_approval`);
...
--
ALTER TABLE `status_approval`
  MODIFY `id_status_approval` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
